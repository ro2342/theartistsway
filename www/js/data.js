...
const WEEKS = [
  ...
  },
  {
    ...
    checklist: [
      ...
      { task: "Liste 5 traços que você gostava em si mesmo quando criança.",
        ...
        link: { type: "list", key: "tracosInfancia" } },
      { task: "Liste 5 conquistas e 5 comidas favoritas da infância — presenteie-se com uma delas essa semana.",
        ...
        link: { type: "list", key: "conquistasComidasInfancia" } },
      { task: "Identifique 3 hábitos autodestrutivos óbvios e 3 mais sutis; anote o 'ganho' de mantê-los.",
        ...
        link: { type: "list", key: "habitosAutodestrutivos" } },
      { task: "Liste amigos que realmente te nutrem (vs. os que te fazem sentir incapaz).",
        ...
        link: { type: "list", key: "amigosQueNutrem" } },
      ...
      { task: "Liste 5 pessoas que você admira abertamente e 5 que admira em segredo; compare os traços.",
        ...
        link: { type: "list", key: "pessoasQueAdmiro" } },
      { task: "Liste 5 pessoas já falecidas que você gostaria de ter conhecido, e 5 falecidas com quem gostaria de 'passar um tempo na eternidade' — compare com as listas de admiração acima.",
        detail: "É uma forma diferente de encontrar seus valores reais: às vezes a gente admira por obrigação (quem 'deveria' admirar) e secretamente se identifica com outra energia completamente diferente.",
        link: { type: "list", key: "pessoasFalecidas" } },
    ],
  ...
  },
  {
    ...
    checklist: [
      ...
      { task: "Escreva uma carta de você aos 80 anos para você hoje.",
        ...
        link: { type: "list", key: "carta80anos" } },
      ...
      { task: "Escreva sua própria Oração do Artista e use-a todos os dias dessa semana.",
        ...
        link: { type: "list", key: "oracaoArtista" } },
      ...
      { task: "Olhe para uma situação da sua vida que você sabe que deveria mudar mas ainda não mudou — o que você ganha, hoje, em continuar travado(a) nela?",
        detail: "Antes de tentar resolver, o livro pede pra encarar o benefício escondido de não resolver. Quase sempre existe um, mesmo que pareça contraintuitivo.",
        link: { type: "list", key: "situacaoQueDeveriaMudar" } },
  ...
  },
  {
    ...
    checklist: [
      { task: "Liste 5 razões pelas quais é difícil confiar num universo/força apoiadora.",
        ...
        link: { type: "list", key: "razoesDesconfianca" } },
      ...
      { task: "Liste 5 aventuras que faria se tivesse 20 anos e dinheiro sobrando.",
        ...
        link: { type: "list", key: "aventurasComDinheiroSobrando" } },
      ...
      { task: "Liste 10 formas pelas quais você é duro(a) demais consigo mesmo(a).",
        ...
        link: { type: "list", key: "durezaComigoMesmo" } },
      { task: "Liste 10 coisas que gostaria de ter e não tem.",
        ...
        link: { type: "list", key: "coisasQueQueroTer" } },
      { task: "Descreva (em palavras ou desenho) qual é o seu bloqueio criativo favorito.",
        ...
        link: { type: "list", key: "bloqueioFavorito" } },
  ...
  },
  {
    ...
    checklist: [
      ...
      { task: "Mande postais ou mensagens para 5 pessoas que você adoraria ouvir de volta.",
        ...
        link: { type: "list", key: "gestosDeConexao" } },
      { task: "Liste seus 'favoritos' em categorias como carros, cachorros, flores, árvores, frutas, vegetais, sobremesas, pratos principais, bandas e cores.",
        ...
        link: { type: "list", key: "meusFavoritos" } },
      ...
      { task: "Preste atenção em qualquer mudança (ou ideia nova, mesmo maluca) na sua relação com dinheiro essa semana — se quiser, adicione uma imagem disso ao seu arquivo de desejos.",
        detail: "Abundância inclui prosperidade material, não só sensorial. O livro trata isso como parte do mesmo músculo: perceber fartura em vez de só focar na escassez.",
        link: { type: "list", key: "relacaoComDinheiro" } },
    ],
  ...
  },
  {
    ...
    checklist: [
      ...
      { task: "Liste 5 filmes favoritos e observe temas em comum — eles aparecem na sua colagem?",
        ...
        link: { type: "list", key: "filmesTemasLeitura" } },
      { task: "Nomeie seus temas favoritos de leitura (religião comparada, ESP, física, romance, esportes, o que for) — eles também aparecem na colagem?",
        detail: "É outra forma de mapear seus interesses reais, além das imagens — comparar os dois lados costuma revelar um padrão temático que você nunca tinha nomeado.",
        link: { type: "list", key: "filmesTemasLeitura" } },
      ...
      { task: "Faça seu mapa da inveja: liste de quem você sente inveja, por quê, e uma ação-antídoto concreta pra cada um.",
        detail: "O livro trata inveja como mapa, não defeito de caráter — cada pontada aponta pra um desejo real ainda não perseguido. Vira ação, não ruminação.",
        link: { type: "list", key: "jealousyMap" } },
    ],
  ...
  },
  {
    ...
    checklist: [
      { task: "Nomeie um sonho secreto: 'Em um mundo perfeito, eu adoraria ser ___'.",
        ...
        link: { type: "list", key: "metasNorteVerdadeiro" } },
      ...
      { task: "Escreva sobre a infância que você teria tido com o cuidado perfeito.",
        ...
        link: { type: "list", key: "arqueologia" } },
      ...
      { task: "Liste 5 coisas que você 'não pode' fazer — e expresse uma delas no papel, no desenho ou dançando.",
        ...
        link: { type: "list", key: "coisasQueNaoPosso" } },
      { task: "Liste 20 coisas que gosta de fazer e categorize (custa dinheiro? sozinho ou acompanhado? relacionado a trabalho?).",
        ...
        link: { type: "list", key: "buscaEstilo" } },
  ...
  },
  {
    ...
    checklist: [
      ...
      { task: "Note se você caiu num padrão de pensamento 'tudo ou nada' sobre alguém ou algo ultimamente ('é ótimo'/'é péssimo', 'amo'/'odeio').",
        detail: "É comum nessa fase do processo. Não é motivo de alarme — só vale perceber, sem tentar corrigir na hora." },
      { task: "Reconheça, por escrito, o valor que as próprias Morning Pages já trouxeram até aqui — dar-se crédito por ter sustentado a prática.",
        detail: "As páginas permitiram desabafar sem se destruir, planejar sem interferência, sonhar sem restrição. O livro pede pra você reconhecer isso explicitamente, não só a si mesmo em silêncio.",
        link: { type: "list", key: "valorMorningPages" } },
      ...
      { task: "Liste suas metas criativas do ano, do mês e da semana.",
        ...
        link: { type: "list", key: "metasAnoMesSemana" } },
      { task: "Nomeie um projeto criativo abandonado ('retorno em U') — ele pode ser resgatado agora?",
        ...
        link: { type: "list", key: "retornosEmU" } },
      { task: "Se bater vontade de abandonar as Morning Pages agora, não desista — só perceba a resistência e escreva mesmo assim.",
        detail: "É comum, nessa altura, as páginas parecerem repentinamente bobas ou inúteis. O livro chama isso de resistência disfarçada, não de sinal real de que a ferramenta parou de funcionar." },
      { task: "Admita, com sinceridade, quais sonhos criativos estão se tornando possíveis demais pra confortar — e reconheça que isso assusta.",
        detail: "Paradoxalmente, sonhos ficando alcançáveis também dá medo. Nomear esse medo tira um pouco do seu poder de travar você silenciosamente." },
      { task: "Escolha um objeto para ser seu 'totem de artista' — algo que desperte ternura pela sua criança-artista.",
        ...
        link: { type: "list", key: "totemArtista" } },
    ],
  ...
  },
  {
    ...
    checklist: [
      { task: "Sorteie um entre 7 temas sensíveis (álcool, drogas, sexo, trabalho, dinheiro, comida, família/amigos) e escreva 5 formas como ele impactou negativamente sua criatividade; repita o sorteio ao longo da semana, podendo repetir temas.",
        detail: "O livro chama isso de 'os fatais' — o tema que mais te incomoda sortear de novo costuma ser, segundo a autora, exatamente o que mais precisa de atenção.",
        link: { type: "list", key: "osFatais" } },
      { task: "Liste seus 'pontos de referência de felicidade' — pequenas coisas que sempre te consolam — e deixe a lista visível.",
        ...
        link: { type: "list", key: "pontosFelicidade" } },
      { task: "Responda com honestidade: qual hábito mais atrapalha sua criatividade hoje? Qual o 'ganho' de mantê-lo?",
        ...
        link: { type: "list", key: "habitoQueAtrapalha" } },
      { task: "Identifique quais amizades alimentam sua dúvida e quais acreditam genuinamente em você.",
        ...
        link: { type: "list", key: "amizadesDuvidaCrenca" } },
      ...
      { task: "Liste 5 pequenas vitórias recentes e 3 ações de cuidado que você já tomou por si.",
        ...
        link: { type: "list", key: "vitoriasCuidado" } },
      { task: "Faça 3 promessas gentis a si mesmo(a) — e cumpra-as.",
        detail: "Diferente de 'fazer algo gentil todo dia': aqui a promessa é específica e feita com antecedência, testando se você mantém compromissos consigo mesmo do jeito que manteria com outra pessoa.",
        link: { type: "list", key: "promessasGentis" } },
  ...
  },
  {
    ...
    checklist: [
      { task: "Grave sua própria voz lendo os Princípios Básicos e um ensaio favorito do livro; use para meditar.",
      ...
      { task: "Comece um caderno de desejos com 7 áreas (saúde, posses, lazer, relações, criatividade, carreira, espiritualidade); liste 10 desejos em cada uma.",
        ...
        link: { type: "list", key: "cadernoDesejos" } },
      { task: "Faça um inventário: como você mudou desde que começou esse processo? Liste também 5 formas como pretende continuar mudando.",
        ...
        link: { type: "list", key: "inventarioMudanca" } },
      { task: "Liste 5 formas como pretende se cuidar nos próximos 6 meses.",
        ...
        link: { type: "list", key: "cuidado6Meses" } },
      { task: "Planeje uma semana inteira de autocuidado: uma ação concreta por dia.",
        ...
        link: { type: "list", key: "semanaAutocuidado" } },
      { task: "Escreva e envie (a si mesmo, por carta ou mensagem) uma carta de encorajamento para sua criança-artista interior.",
        ...
        link: { type: "list", key: "cartaEncorajamento" } },
      ...
      { task: "Liste 10 exemplos pessoais de sincronicidade — momentos em que algo pareceu 'colaborar' com você depois que se comprometeu com algo.",
        detail: "Reunir os exemplos num só lugar (em vez de deixá-los soltos na memória) reforça a confiança de que esse padrão é real na sua vida, não coincidência isolada.",
        link: { type: "list", key: "sincronicidade" } },
    ],
  ...
  },
  {
    ...
    checklist: [
      { task: "Escreva suas resistências, medos e raivas sobre continuar esse processo sem o suporte estruturado das 12 semanas.",
        ...
        link: { type: "list", key: "resistenciasMedosContinuar" } },
      { task: "Observe suas áreas atuais de procrastinação — qual medo está escondido por trás delas?",
        ...
        link: { type: "list", key: "areasProcrastinacao" } },
      ...
      { task: "Escreva novas afirmações sobre sua criatividade daqui para frente.",
        ...
        link: { type: "list", key: "minhasAfirmacoes" } },
      { task: "Faça um pequeno gesto de cuidado com algo ao seu redor — conserte algo que precisa de conserto, ou replante uma planta enfraquecida.",
        detail: "São gestos simbólicos e concretos que o livro sugere pra fechar o ciclo: cuidar do que está ao seu redor reflete o cuidado que você aprendeu a ter consigo mesmo(a)." },
      ...
      { task: "Use esse recipiente: escreva um medo, coloque-o ali e tome a próxima pequena ação possível mesmo assim.",
        ...
        link: { type: "list", key: "recipientePreocupacoes" } },
      ...
      { task: "Liste 5 pessoas com quem você pode compartilhar seus sonhos criativos e planos futuros.",
        ...
        link: { type: "list", key: "pessoasCompartilharSonhos" } },
      { task: "Decida como você vai manter as Morning Pages e o Artist Date depois dessas 12 semanas.",
        ...
        link: { type: "list", key: "planoContinuidade" } },
    ],
...
const UI_STRINGS = {
  ...
  "sync.notLoggedIn": "Não logado — nada pra sincronizar.",
  "sync.sessionExpired": "Sessão expirada — entre de novo.",
  "sync.syncedAt": "Sincronizado às {time}",
  "sync.failed": "Falha ao sincronizar (tentará de novo mais tarde): {error}",

  "settings.sync.statusNotLoggedIn": "Não logado.",
  "settings.sync.statusLoggedInWithProvider": "Logado como {who} ({provider}).",
  "settings.sync.statusLoggedIn": "Logado como {who}.",
  "settings.sync.loggingIn": "Entrando...",
  "settings.sync.loginButton": "Entrar com Google",
  "settings.sync.loginSyncing": "Login OK — sincronizando...",
  "settings.sync.syncNowButton": "Sincronizar agora",
  "settings.sync.dialogLoginOkTitle": "Login OK",
  "settings.sync.dialogLoginFailedTitle": "Login falhou",
  "settings.sync.description": "Login com Google sincroniza seu progresso entre aparelhos automaticamente em segundo plano — funciona junto com {otherPlatform}, no mesmo login.",
  "settings.sync.otherPlatformName": "o PWA",
  "settings.dangerZone.description": "Apaga o progresso salvo (perfil, Morning Pages, Artist Dates, checklist, check-ins). Não tem como desfazer — faça um backup antes se quiser guardar alguma coisa.",
  "settings.resetDone": "Dados apagados — reinicie o app pra configurar de novo.",

  "settings.backup.fileTypeJson": "Arquivo JSON",
  "settings.backup.exportedToast": "Backup salvo ✓",
  "settings.backup.importedToast": "Backup importado ✓",
  "settings.backup.exportedStatus": "Backup exportado.",
  "settings.backup.importedStatus": "Backup importado.",
  "settings.backup.invalidFile": "Arquivo inválido",
  "settings.backup.exportError": "Erro ao salvar backup: {error}",
  "settings.backup.importError": "Erro ao importar backup: {error}",
  "settings.backup.unknownError": "desconhecido",
  "settings.backup.importErrorDialogTitle": "Erro",
  "settings.backup.importErrorDialogMessage": "Não foi possível importar esse arquivo.",

  "settings.appearance.themeLight": "Claro",
  "settings.appearance.themeDark": "Escuro",
  "settings.appearance.themeAuto": "Automático",
  "settings.appearance.themeAutoShort": "Auto",

  "updates.installedChecking": "Versão instalada: {version}. Verificando se há atualização...",
  "updates.installedCheckFailed": "Versão instalada: {version}. Não foi possível checar agora.",
  "updates.installedCheckFailedWithError": "Versão instalada: {version}. Não foi possível checar agora ({error}).",
  "updates.installedNewVersionAvailable": "Versão instalada: {version}. Nova versão disponível: {latest}.",
  "updates.installedUpToDate": "Versão instalada: {version}. Atualizado ✓",
  "updates.downloadButton": "Baixar atualização",
  "updates.installButton": "Instalar atualização",
  "updates.downloading": "Baixando atualização...",
  "updates.downloadingWithProgress": "Baixando... {percent}%",
  "updates.downloadFailed": "Falha ao baixar a atualização: {error}",
  "updates.chooseDownloadFolder": "Escolha uma pasta de download pra continuar.",
  "updates.downloadedReadyToInstall": "Atualização baixada — toque pra instalar.",
  "updates.webVersionAutoUpdatesWithVersion": "Versão {version} — a versão web se atualiza sozinha, sem precisar checar nada aqui.",
  "updates.webVersionAutoUpdates": "Você está usando a versão web — ela se atualiza sozinha, sem precisar checar nada aqui.",
  "updates.checkHttpError": "HTTP {code}",
  "updates.checkNoVersionName": "resposta sem versionName",

  "auth.noTokenReturned": "Google não devolveu id_token nem access_token.",
  "auth.googleError": "Google: {error}",
  "auth.deviceCodeHttpError": "Google device/code {status}: {body}",
  "auth.deviceLoginTimeout": "Tempo esgotado esperando a confirmação do login.",
  "auth.browserError": "Navegador: {status} ({detail})",
  "auth.noAuthCode": "Resposta do Google sem código de autorização.",
  "auth.tokenHttpError": "Google token {status}: {body}",
  "auth.firebaseHttpError": "Firebase {status}: {body}",
  "auth.firebaseExchangeFailed": "Troca com Firebase falhou: {error}",
  "auth.noGoogleAccountAndroid": "Nenhuma conta Google encontrada nesse aparelho. Confira em Configurações > Contas se há uma conta Google adicionada (não é a mesma coisa que estar logado num app específico) e se a Play Store está instalada.",
  "auth.loginCancelledOrFailed": "Login cancelado ou falhou.",
  "auth.credentialNotGoogleIdToken": "Credencial devolvida não é um Google ID token.",
  "auth.noGoogleCredentialFound": "Nenhuma credencial Google encontrada.",
  "auth.firebaseLoginFailed": "Falha no login com o Firebase.",
  "app.unhandledExceptionTitle": "Erro inesperado no app",
  "app.unhandledExceptionUnknown": "Erro desconhecido",

  "circulo.headerSub": "quem apoia, quem exige cautela",
  "circulo.description": "Quem apoia — e de quem se proteger por enquanto.",
  "circulo.addButton": "Adicionar em \"Apoia\"",
  "circulo.safeSectionTitle": "Apoia",
  "circulo.cautionSectionTitle": "Cautela",
  "circulo.moveToCaution": "Mover pra Cautela",
  "circulo.moveToSafe": "Mover pra Apoia",

  "lifePie.subtitle": "seu círculo de vida",
  "lifePie.hint": "Arraste dentro do gráfico pra ajustar o eixo mais próximo (0 a 10).",
  "lifePie.hintPreviousNote": " A silhueta clara mostra o snapshot anterior, pra comparar.",
  "lifePie.saveButton": "Salvar snapshot de hoje",
  "lifePie.savedToast": "Snapshot salvo",
  "lifePie.historyTitle": "Snapshots salvos",
  "lifePie.categorySpiritualidade": "Espiritualidade",
  "lifePie.categoryTrabalho": "Trabalho",
  "lifePie.categoryLazer": "Lazer",
  "lifePie.categoryAmigos": "Amigos",
  "lifePie.categoryRomance": "Romance",
  "lifePie.categoryExercicio": "Exercício",

  "artistDateHistory.subtitle": "todos os encontros já registrados, do mais recente pro mais antigo",
  "artistDateHistory.emptyState": "Nenhum Artist Date registrado ainda.",
  "artistDateHistory.suffixDone": " — feito",
  "artistDateHistory.suffixPlanned": " — planejado",

  "checkinHistory.subtitle": "toque numa semana com check-in salvo pra reler suas respostas",
  "checkinHistory.entryWithCheckin": "Semana {week} — ver check-in",
  "checkinHistory.entryWithoutCheckin": "Semana {week} — sem check-in ainda",

  "ferramentas.generalTab": "Geral",
  "ferramentas.quizFallbackTitle": "Quiz",
  ...
  "tile.streakSingular": "1 dia seguido",
  "tile.streakPlural": "{count} dias seguidos",
  "tile.streakNone": "Comece hoje",
  "tile.dayCount": "Dia {day} de {total}",
  "tile.pendingSingular": "1 pendente essa semana",
  "tile.pendingPlural": "{count} pendentes essa semana",
  "tile.allDone": "Semana em dia",
  ...
  "status.done": "feito",
  "status.notDone": "não feito",

  "home.greeting.dayCount": "Dia {day} de {total}",
  "home.greeting.withName": "Olá, {name}",
  "home.greeting.default": "seu companheiro de jornada",

  "home.maintenance.title": "Modo manutenção",
  "home.maintenance.description": "As 12 semanas terminaram — agora é só manter Morning Pages e Artist Date no seu ritmo.",

  "home.weekCycle.title": "A Semana {week} completou os 7 dias",
  "home.weekCycle.summary": "{done}/{total} tarefas concluídas · Morning Pages em {mp}/7 dias · Artist Date {adStatus} · check-in {ciStatus}.",
  "home.weekCycle.question": "Quer continuar mais um tempo na Semana {week} ou seguir em frente?",
  "home.weekCycle.stayButton": "Continuar na Semana {week}",
  "home.weekCycle.advanceButton": "Ir para a Semana {week}",
  "home.weekCycle.finishButton": "Concluir o programa",

  "home.week.label": "Semana {week} de 12",
  "home.week.progress": "{done}/{total} tarefas dessa semana concluídas",
  "home.week.openButton": "Ver tarefas da semana",

  "home.morningPages.title": "Morning Pages",
  "home.morningPages.thisWeek": "Esta semana",
  "home.morningPages.hint": "Esqueceu de marcar um dia? Toque na bolinha dele.",
  "home.morningPages.toggleOn": "Marcar páginas de hoje como feitas",
  "home.morningPages.toggleOff": "✓ Páginas de hoje feitas",
  "home.morningPages.weekdayLetters": "D,S,T,Q,Q,S,S",

  "home.affirmation.label": "Afirmação de hoje",

  "home.artistDate.title": "Artist Date dessa semana",
  "home.artistDate.doneSummary": "Feito — {idea}",
  "home.artistDate.notDoneSummary": "Ainda não rolou essa semana.",
  "home.artistDate.planButton": "Planejar meu Artist Date",
  "home.artistDate.viewButton": "Ver / trocar",

  "home.checkin.prompt": "Prefere revisar a semana agora?",
  "home.checkin.button": "Ir para o check-in da Semana {week}",

  "home.roadRulesNudge.prompt": "Faz uns dias que você não passa por aqui.",
  "home.roadRulesNudge.button": "Já revisou as Regras da Estrada?",

  "home.toast.mpMarked": "Páginas de hoje marcadas ✓",
  "home.toast.mpUnmarked": "Desmarcado",
  "home.toast.stayedWeek": "Continuando na Semana {week}",
  "home.toast.advancedWeek": "Seguindo pra próxima semana",
  "home.toast.finishedProgram": "Programa concluído — modo manutenção ativado",

  "common.weekdayNames": "Domingo,Segunda,Terça,Quarta,Quinta,Sexta,Sábado",
  "common.timePickerChangeButton": "Trocar",

  "onboarding.appTitle": "The Artist's Way — Companheiro",
  "onboarding.backButton": "← Voltar",

  "onboarding.returningUser.question": "Você já usa esse app em outro aparelho?",
  "onboarding.returningUser.description": "Entre com a mesma conta Google pra trazer seus dados agora, sem preencher tudo de novo.",
  "onboarding.returningUser.loginButton": "Já sou usuário(a) — entrar com Google",
  "onboarding.returningUser.loggingIn": "Entrando...",
  "onboarding.returningUser.skipButton": "Começar sem login",
  "onboarding.returningUser.redirectStatus": "Você vai ser levado(a) pro login do Google e volta pra cá.",
  "onboarding.returningUser.loggingInStatus": "Entrando com o Google...",
  "onboarding.returningUser.loginFailedDefault": "Login cancelado.",
  "onboarding.returningUser.syncingStatus": "Login OK — buscando seus dados...",
  "onboarding.returningUser.noDataFoundStatus": "Login OK, mas não achei dados salvos com essa conta. Vamos configurar do zero — a partir de agora, tudo já fica salvo na nuvem.",

  "onboarding.welcome.quote": "\"A criatividade recuperada nunca é perdida de novo.\"",
  "onboarding.welcome.description": "Um espaço para transformar as tarefas do livro em passos claros, um dia de cada vez. Vamos organizar sua jornada de 12 semanas.",
  "onboarding.welcome.startButton": "Começar",

  "onboarding.nameDate.title": "Como posso te chamar?",
  "onboarding.nameDate.subtitle": "E quando você quer começar sua Semana 1 (domingo a sábado)?",
  "onboarding.nameDate.nameLabel": "Nome",
  "onboarding.nameDate.namePlaceholder": "Seu nome",
  "onboarding.nameDate.startDateLabel": "Início da Semana 1",
  "onboarding.continueButton": "Continuar",

  "onboarding.rituals.title": "Seus rituais",
  "onboarding.rituals.subtitle": "Quando você prefere ser lembrado(a) de cada hábito?",
  "onboarding.rituals.morningPagesSection": "Morning Pages (todo dia)",
  "onboarding.rituals.artistDateSection": "Artist Date (semanal)",
  "onboarding.rituals.checkinSection": "Check-in semanal",
  "onboarding.rituals.timeLabel": "Horário",
  "onboarding.rituals.weekdayLabel": "Dia da semana",

  "onboarding.contract.title": "Seu contrato inicial",
  "onboarding.contract.description": "O livro abre com um compromisso de 12 semanas: Morning Pages todo dia, Artist Date semanal, e cuidado consigo mesmo(a) ao longo do processo. Assine com seu nome pra começar.",
  "onboarding.contract.sentence": "Eu, {name}, me comprometo com 12 semanas de recuperação criativa: escrever minhas Morning Pages todos os dias, fazer meu Artist Date toda semana, e ser gentil comigo mesmo(a) no caminho.",
  "onboarding.contract.signatureLabel": "Assinatura (seu nome)",
  "onboarding.contract.signaturePlaceholder": "Seu nome",
  "onboarding.contract.finishButton": "Assinar e começar",

  "onboarding.toast.done": "Tudo pronto! Bem-vindo(a)",
  "onboarding.toast.errorPrefix": "Erro ao concluir: ",

  "artistDate.weekLabel": "semana {week}",
  "artistDate.description": "Um encontro solo, só por prazer — sem culpa, sem produtividade.",
  "artistDate.summaryTitle": "Sua ideia pra essa semana",
  "artistDate.noIdeaYet": "Nenhuma ideia registrada ainda pra essa semana.",
  "artistDate.markDoneButton": "Marcar como feito essa semana",
  "artistDate.doneButton": "✓ Artist Date dessa semana feito",
  "artistDate.editButton": "Editar date",
  "artistDate.ideaPlaceholder": "Toque em 'sortear' ou escreva aqui o seu próprio plano...",
  "artistDate.shuffleButton": "Sortear outra ideia",
  "artistDate.saveButton": "Salvar Date",
  "artistDate.calendarEventTitle": "Artist Date",
  "artistDate.calendarEventDescription": "Um encontro solo, só por prazer, para encher o poço criativo. Companheiro The Artist's Way.",
  "artistDate.addWindowsCalendarButton": "+ Adicionar lembrete recorrente no Calendário do Windows",
  "artistDate.addAndroidCalendarButton": "Adicionar ao Calendário",
  "artistDate.googleCalendarPrompt": "Quer que apareça no seu Google Calendar toda semana?",
  "artistDate.addGoogleCalendarButton": "Adicionar lembrete recorrente",
  "artistDate.toastSaved": "Date salvo",
  "artistDate.toastDone": "Aproveite seu Artist Date!",
  "artistDate.toastUndone": "Desmarcado",

  "checkin.header": "Check-in — Semana {week}",
  "checkin.pwaTitle": "Check-in",
  "checkin.pwaSubtitle": "semana {week}",
  "checkin.saveButton": "Salvar check-in",
  ...
  "profile.mpTimeLabel": "Horário das Morning Pages",
  "profile.adDayLabel": "Dia do Artist Date",
  "profile.adTimeLabel": "Horário do Artist Date",
  "profile.ciDayLabel": "Dia do check-in",
  "profile.ciTimeLabel": "Horário do check-in",
  "profile.adSectionTitle": "Artist Date",
  "profile.windowsCalendarSectionTitle": "Calendário do Windows",
  "profile.windowsCalendarSectionDescription": "Adiciona o compromisso recorrente direto no app de Calendário do aparelho.",
  "profile.googleCalendarSectionTitle": "Google Calendar",
  "profile.googleCalendarSectionDescription": "Um toque adiciona o compromisso recorrente direto no seu calendário.",
  "profile.addMpCalendarButton": "+ Morning Pages diário",
  "profile.addAdCalendarButton": "+ Artist Date semanal",
  "profile.addCiCalendarButton": "+ Check-in semanal",
  "profile.savedDialogTitle": "Tudo certo",
  "profile.savedMessage": "Ajustes salvos e lembretes atualizados.",
};
...
const TOOL_CONFIGS = {
  ...
  situacaoQueDeveriaMudar: {
    listName: "situacaoQueDeveriaMudar",
    title: "Situação que Eu Sei que Deveria Mudar",
    subtitle: "Uma situação que você sabe que deveria mudar mas ainda não mudou — e o que você ganha, hoje, em continuar travado(a) nela.",
    singleton: true,
    fields: [
      { key: "situacao", label: "A situação", multiline: true },
      { key: "ganho", label: "O que eu ganho em continuar travado(a) nela", multiline: true },
    ],
    week: 4,
  },
  resentimentosMedos: {
  ...
  // Semana 3
  tracosInfancia: {
    listName: "tracosInfancia",
    title: "Traços que Eu Gostava em Mim",
    subtitle: "5 traços que você gostava em si mesmo quando criança — antes das expectativas adultas.",
    fields: [{ key: "traco", label: "Traço", multiline: false }],
    week: 3,
  },
  conquistasComidasInfancia: {
    listName: "conquistasComidasInfancia",
    title: "Conquistas e Comidas Favoritas da Infância",
    subtitle: "5 conquistas e 5 comidas favoritas de quando você era criança — presenteie-se com uma delas essa semana.",
    singleton: true,
    fields: [
      { key: "conquistas", label: "5 conquistas da infância", multiline: true },
      { key: "comidas", label: "5 comidas favoritas da infância", multiline: true },
    ],
    week: 3,
  },
  habitosAutodestrutivos: {
    listName: "habitosAutodestrutivos",
    title: "Hábitos Autodestrutivos",
    subtitle: "3 óbvios e 3 mais sutis — todo hábito que sabota tem um 'ganho' escondido. Nomear esse ganho é o primeiro passo pra soltar o hábito sem culpa.",
    fields: [
      { key: "habito", label: "Hábito", multiline: false },
      { key: "tipo", label: "Óbvio ou sutil?", multiline: false },
      { key: "ganho", label: "Ganho escondido em manter", multiline: true },
    ],
    week: 3,
  },
  amigosQueNutrem: {
    listName: "amigosQueNutrem",
    title: "Amigos que Nutrem vs. Drenam",
    subtitle: "Quem realmente nutre sua criatividade, e quem te faz sentir incapaz — nutrir é diferente de ajudar demais.",
    fields: [
      { key: "nome", label: "Nome", multiline: false },
      { key: "tipo", label: "Nutre ou drena?", multiline: false },
    ],
    week: 3,
  },
  pessoasQueAdmiro: {
    listName: "pessoasQueAdmiro",
    title: "Pessoas que Admiro (Aberto e em Segredo)",
    subtitle: "5 que admira abertamente e 5 em segredo — admirações secretas costumam apontar pra desejos que você julga bobos demais pra admitir.",
    fields: [
      { key: "pessoa", label: "Pessoa", multiline: false },
      { key: "tipo", label: "Aberta ou secreta?", multiline: false },
    ],
    week: 3,
  },
  pessoasFalecidas: {
    listName: "pessoasFalecidas",
    title: "Pessoas Falecidas",
    subtitle: "5 que gostaria de ter conhecido, e 5 com quem passaria um tempo na eternidade — compare com suas listas de admiração.",
    fields: [
      { key: "pessoa", label: "Pessoa", multiline: false },
      { key: "categoria", label: "Conhecer ou eternidade?", multiline: false },
    ],
    week: 3,
  },
  ...
  // Semana 5
  razoesDesconfianca: {
    listName: "razoesDesconfianca",
    title: "Razões pra Desconfiar do Universo",
    subtitle: "5 razões pelas quais é difícil confiar numa força/universo que te apoia — nomear tira do modo 'ruído de fundo'.",
    fields: [{ key: "razao", label: "Razão", multiline: true }],
    week: 5,
  },
  aventurasComDinheiroSobrando: {
    listName: "aventurasComDinheiroSobrando",
    title: "Se Eu Tivesse 20 / Se Eu Tivesse 65",
    subtitle: "5 aventuras se tivesse 20 anos e dinheiro sobrando, e 5 prazeres adiados se tivesse 65 — remove a desculpa da idade dos dois lados.",
    singleton: true,
    fields: [
      { key: "aventuras20", label: "5 aventuras com 20 anos e dinheiro sobrando", multiline: true },
      { key: "prazeres65", label: "5 prazeres adiados, com 65 anos e dinheiro sobrando", multiline: true },
    ],
    week: 5,
  },
  durezaComigoMesmo: {
    listName: "durezaComigoMesmo",
    title: "Formas que Sou Duro(a) Comigo Mesmo(a)",
    subtitle: "10 formas — tornar a autocrítica explícita ajuda a ver o quanto dela é automática e nem sempre justa.",
    fields: [{ key: "forma", label: "Forma", multiline: true }],
    week: 5,
  },
  coisasQueQueroTer: {
    listName: "coisasQueQueroTer",
    title: "Coisas que Gostaria de Ter",
    subtitle: "10 coisas que gostaria de ter e não tem — só de visualizar já muda o quanto você repara em oportunidades relacionadas.",
    fields: [{ key: "coisa", label: "Coisa", multiline: false }],
    week: 5,
  },
  bloqueioFavorito: {
    listName: "bloqueioFavorito",
    title: "Meu Bloqueio Favorito",
    subtitle: "Todo mundo tem um 'bloqueio de estimação' — reconhecer o seu com humor tira um pouco do peso dele.",
    singleton: true,
    fields: [
      { key: "bloqueio", label: "Descreva (em palavras) seu bloqueio criativo favorito", multiline: true },
      { key: "ganho", label: "Qual o \"ganho\" de continuar bloqueado(a)? Quem você culpa por isso?", multiline: true },
    ],
    week: 5,
  },
  ...
  // Semana 6
  meusFavoritos: {
    listName: "meusFavoritos",
    title: "Meus Favoritos",
    subtitle: "Listar favoritos com atenção reafirma sua identidade pessoal — o oposto de viver no piloto automático.",
    singleton: true,
    fields: [
      { key: "carro", label: "Carro", multiline: false },
      { key: "cachorro", label: "Cachorro (raça)", multiline: false },
      { key: "flor", label: "Flor", multiline: false },
      { key: "arvore", label: "Árvore", multiline: false },
      { key: "fruta", label: "Fruta", multiline: false },
      { key: "vegetal", label: "Vegetal", multiline: false },
      { key: "sobremesa", label: "Sobremesa", multiline: false },
      { key: "pratoPrincipal", label: "Prato principal", multiline: false },
      { key: "banda", label: "Banda", multiline: false },
      { key: "cor", label: "Cor", multiline: false },
    ],
    week: 6,
  },
  ...
  // Semana 7
  filmesTemasLeitura: {
    listName: "filmesTemasLeitura",
    title: "Filmes e Temas de Leitura Favoritos",
    subtitle: "5 filmes favoritos e seus temas de leitura preferidos — veja se os mesmos temas aparecem na sua colagem.",
    singleton: true,
    fields: [
      { key: "filmes", label: "5 filmes favoritos", multiline: true },
      { key: "temasLeitura", label: "Temas de leitura favoritos", multiline: true },
    ],
    week: 7,
  },
  gestosDeConexao: {
    listName: "gestosDeConexao",
    title: "Gestos de Conexão",
    subtitle: "Postais ou mensagens pra quem você adoraria ouvir de volta — dar e receber afeto sem segunda intenção.",
    fields: [
      { key: "pessoa", label: "Pra quem", multiline: false },
      { key: "mensagem", label: "O que mandou (opcional)", multiline: true },
    ],
    week: 6,
  },
  relacaoComDinheiro: {
    listName: "relacaoComDinheiro",
    title: "Minha Relação com Dinheiro Essa Semana",
    subtitle: "Qualquer mudança (ou ideia nova, mesmo maluca) que notou — abundância inclui prosperidade material, não só sensorial.",
    singleton: true,
    fields: [{ key: "texto", label: "O que notei", multiline: true }],
    week: 6,
  },

  // Semana 8
  coisasQueNaoPosso: {
    listName: "coisasQueNaoPosso",
    title: "Coisas que 'Não Posso' Fazer",
    subtitle: "5 coisas que você 'não pode' fazer — extravasar uma delas simbolicamente ajuda a diferenciar limite real de auto-repressão desnecessária.",
    fields: [{ key: "coisa", label: "Coisa", multiline: false }],
    week: 8,
  },
  euComoCor: {
    listName: "euComoCor",
    title: "Eu Como Cor",
    subtitle: "Escolha uma cor e escreva-se na primeira pessoa como se você fosse ela.",
    singleton: true,
    fields: [
      { key: "cor", label: "A cor escolhida", multiline: false },
      { key: "texto", label: "Você, na primeira pessoa, como essa cor", multiline: true },
    ],
    week: 8,
  },
  ...
  // Semana 9
  metasAnoMesSemana: {
    listName: "metasAnoMesSemana",
    title: "Metas Criativas: Ano, Mês, Semana",
    subtitle: "Alinhar os três horizontes de tempo evita o erro comum de metas anuais grandiosas sem nenhuma ação semanal que as sustente.",
    singleton: true,
    fields: [
      { key: "metaAno", label: "Meta do ano", multiline: true },
      { key: "metaMes", label: "Meta do mês", multiline: true },
      { key: "metaSemana", label: "Meta da semana", multiline: true },
    ],
    week: 9,
  },
  valorMorningPages: {
    listName: "valorMorningPages",
    title: "O Valor das Minhas Morning Pages",
    subtitle: "Reconheça, por escrito, o que as Morning Pages já trouxeram até aqui — dar-se crédito por ter sustentado a prática.",
    singleton: true,
    fields: [{ key: "texto", label: "O que as Morning Pages já trouxeram pra mim", multiline: true }],
    week: 9,
  },
  cenaIdeal: {
    listName: "cenaIdeal",
    title: "Cena Ideal",
    subtitle: "Você, no presente, vivendo sua meta plenamente realizada — escrita pra ler em voz alta e manter visível.",
    singleton: true,
    fields: [{ key: "texto", label: "Sua cena ideal (escrita no presente)", multiline: true }],
    week: 9,
  },
  ...
  osFatais: {
    listName: "osFatais",
    title: "Os Fatais",
    subtitle: "Sorteie um tema sensível (álcool, drogas, sexo, trabalho, dinheiro, comida, família/amigos) e liste como ele impactou negativamente sua criatividade — repita o sorteio ao longo da semana, pode repetir tema.",
    fields: [
      { key: "tema", label: "Tema sorteado", multiline: false },
      { key: "impacto", label: "Como impactou sua criatividade", multiline: true },
    ],
    week: 10,
  },
  amizadesDuvidaCrenca: {
    listName: "amizadesDuvidaCrenca",
    title: "Amizades: Dúvida vs. Crença",
    subtitle: "Quem alimenta sua dúvida e quem acredita genuinamente em você — não é sobre cortar ninguém, é sobre clareza de quem procurar em fases sensíveis.",
    fields: [
      { key: "nome", label: "Nome", multiline: false },
      { key: "tipo", label: "Alimenta dúvida ou acredita em mim?", multiline: false },
    ],
    week: 10,
  },
  vitoriasCuidado: {
    listName: "vitoriasCuidado",
    title: "Pequenas Vitórias e Ações de Cuidado",
    subtitle: "5 vitórias recentes e 3 ações de cuidado que você já tomou por si — reconhecer progresso contrabalança a tendência de só notar o que falta.",
    singleton: true,
    fields: [
      { key: "vitorias", label: "5 pequenas vitórias recentes", multiline: true },
      { key: "cuidados", label: "3 ações de cuidado que já tomei por mim", multiline: true },
    ],
    week: 10,
  },
  habitoQueAtrapalha: {
    listName: "habitoQueAtrapalha",
    title: "Hábito que Mais Atrapalha",
    subtitle: "O hábito que mais atrapalha sua criatividade hoje, e o 'ganho' escondido em mantê-lo.",
    singleton: true,
    fields: [
      { key: "habito", label: "O hábito", multiline: false },
      { key: "ganho", label: "O ganho em mantê-lo", multiline: true },
    ],
    week: 10,
  },
  promessasGentis: {
    listName: "promessasGentis",
    title: "Promessas Gentis",
    subtitle: "Promessas específicas que você faz a si mesmo(a) — e se compromete a cumprir, do jeito que cumpriria com outra pessoa.",
    fields: [{ key: "promessa", label: "Promessa", multiline: false }],
    week: 10,
  },

  // Semana 11
  inventarioMudanca: {
    listName: "inventarioMudanca",
    title: "Inventário de Mudança",
    subtitle: "Como você mudou desde a Semana 1, e 5 formas como pretende continuar mudando — esse balanço, perto do fim, costuma revelar mais transformação do que você percebeu dia a dia.",
    singleton: true,
    fields: [
      { key: "comoMudei", label: "Como mudei desde o início", multiline: true },
      { key: "comoVouContinuar", label: "5 formas como pretendo continuar mudando", multiline: true },
    ],
    week: 11,
  },
  cuidado6Meses: {
    listName: "cuidado6Meses",
    title: "Como Vou Me Cuidar nos Próximos 6 Meses",
    subtitle: "5 formas — pensar além da duração do programa ajuda a tratar essas 12 semanas como início de um hábito, não um evento isolado.",
    fields: [{ key: "forma", label: "Forma de cuidado", multiline: false }],
    week: 11,
  },
  semanaAutocuidado: {
    listName: "semanaAutocuidado",
    title: "Semana de Autocuidado",
    subtitle: "Uma ação concreta de autocuidado por dia — planeje a semana inteira, um dia de cada vez.",
    fields: [
      { key: "dia", label: "Dia", multiline: false },
      { key: "acao", label: "Ação de autocuidado", multiline: true },
    ],
    week: 11,
  },

  // Semana 12
  pessoasCompartilharSonhos: {
    listName: "pessoasCompartilharSonhos",
    title: "Pessoas com Quem Compartilhar Meus Sonhos",
    subtitle: "5 pessoas com quem você pode compartilhar seus sonhos criativos e planos futuros — a recuperação criativa não precisa ser solitária depois que o programa termina.",
    fields: [{ key: "pessoa", label: "Pessoa", multiline: false }],
    week: 12,
  },
  resistenciasMedosContinuar: {
    listName: "resistenciasMedosContinuar",
    title: "Resistências, Medos e Raivas sobre Continuar",
    subtitle: "O que você sente sobre seguir esse processo sem o suporte estruturado das 12 semanas.",
    singleton: true,
    fields: [{ key: "texto", label: "Suas resistências, medos e raivas", multiline: true }],
    week: 12,
  },
  areasProcrastinacao: {
    listName: "areasProcrastinacao",
    title: "Áreas de Procrastinação",
    subtitle: "Onde você está procrastinando agora, e o medo escondido por trás de cada área.",
    fields: [
      { key: "area", label: "Área", multiline: false },
      { key: "medo", label: "O medo por trás", multiline: true },
    ],
    week: 12,
  },
  recipientePreocupacoes: {
    listName: "recipientePreocupacoes",
    title: "Recipiente de Preocupações",
    subtitle: "Seu 'pote de preocupações' digital — escreva um medo, solte o controle sobre ele, e tome a próxima pequena ação possível mesmo assim.",
    fields: [{ key: "medo", label: "O medo que estou soltando aqui", multiline: true }],
    week: 12,
  },
};
